 ...
 * demonstrates how to use that API.this program allows you to callibrate the white
 * value for the color sensor. point the sensor at something you want the sensor to
 * to detect as white and press the [enter] button.
 *
 * Changelog:
 * - 0.1: Initial release
 * - 0.2: Changed the intro and info display
 * - 0.3: More comments
